...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, -1, sizeof(::greeter::HelloReply)},
};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "greeter.HelloReply.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
template<> PROTOBUF_NOINLINE ::greeter::HelloReply*
Arena::CreateMaybeMessage< ::greeter::HelloReply >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greeter::HelloReply >(arena);
}
